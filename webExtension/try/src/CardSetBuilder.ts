...
export class CardSetBuilder {
  ...
  cardDefinitions: Array<string> = Array()
  cardExamples: Array<string> = Array()
  cardSynonyms: Array<string> = Array()
  ...
  startCard() {
    ...
    this.cardDefinitions = Array()
    this.cardExamples = Array()
    this.cardSynonyms = Array()
